...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Doctor drKim = new Doctor(null, "Dr. David Kim, MD, FAAOS", "Director of Orthopedics & Joint Care", ortho, "MD, FAAOS - Johns Hopkins University", 16, BigDecimal.valueOf(4.93), 210, new BigDecimal("200.00"), "https://images.unsplash.com/photo-1622253692010-333f2da6031d?auto=format&fit=crop&w=800&q=80", "Specializing in robotic minimally invasive joint reconstruction, arthroscopic preservation, and spinal rehabilitation.", "Mon,Wed,Thu,Fri", LocalDateTime.now());
        Doctor drTorres = new Doctor(null, "Dr. Robert Torres, MD, FACEP", "Director of Emergency Medicine & Trauma", emergency, "MD, FACEP - Harvard Medical School", 19, BigDecimal.valueOf(4.97), 320, new BigDecimal("190.00"), "https://images.unsplash.com/photo-1537368910025-700350fe46c7?auto=format&fit=crop&w=800&q=80", "Leader in round-the-clock polytrauma triage, acute coronary resuscitation, and comprehensive hyper-acute stroke intervention.", "Mon,Tue,Wed,Thu,Fri,Sat,Sun", LocalDateTime.now());
        ...
        drKim = doctorRepository.save(drKim);
        drTorres = doctorRepository.save(drTorres);
