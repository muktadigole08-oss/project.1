...
public class Department {
    ...
    public Department(Long id, String name, String code, String description, String icon,
                      String headDoctorName, Integer bedCount, String floorNumber, Boolean active, LocalDateTime createdAt) {
        this.id = id;
        this.name = name;
        this.code = code;
